"""
Generate STROBE checklist for cross-sectional study (JATM submission).
Updated abstract section headings for JATM format
...
def create_strobe_checklist():
    ...
    items = [
        ...
        ('Setting', '5',
         ...
         'Materials and Methods: eBay/Terapeak, data collected March 2026, '
         'covering 28 March 2023\u201324 March 2026'),
        ('Participants', '6',
        ...
        ('Variables', '7',
         ...
         'Materials and Methods, \u201cVariables\u201d: primary outcome (sale price), '
         'exposure (regulatory period), agent type'),
        ('Data sources/measurement', '8',
         'For each variable of interest, give sources of data and details of methods of assessment',
         'Materials and Methods: Terapeak product research tool; automated data retrieval '
         'with manual screening against eligibility criteria'),
        ('Bias', '9',
         'Describe any efforts to address potential sources of bias',
         'Materials and Methods/Discussion: single marketplace to avoid cross-listing '
         'duplicates; natural comparator groups (sevoflurane, isoflurane); '
         'causal limitations acknowledged'),
        ('Study size', '10',
         'Explain how the study size was arrived at',
         'Materials and Methods, \u201cStatistical analysis\u201d: all available transactions '
         'within Terapeak window; no a priori sample size calculation'),
        ('Quantitative variables', '11',
         'Explain how quantitative variables were handled in the analyses',
         'Materials and Methods: prices in USD; regulatory period classified by milestones; '
         'trend analyses used continuous (days) and ordinal (phase 1\u20135) variables'),
        ('Statistical methods', '12',
         '(a) Describe all statistical methods',
         'Materials and Methods, \u201cStatistical analysis\u201d: Spearman \u03c1 (primary), '
         'Kendall \u03c4, Mann\u2013Whitney U (exploratory), Welch\u2019s t-test, '
         'Cohen\u2019s d, LOWESS'),
        ('', '',
         '(b) Describe any methods used to examine subgroups and interactions',
         'Analyses performed separately for each agent type; '
         'supplementary asking-price analysis'),
        ('', '',
         '(c) Explain how missing data were addressed',
         'Materials and Methods, \u201cEligibility criteria\u201d: '
         'listings with missing price data excluded'),
        ('', '',
         '(d) If applicable, describe analytical methods taking account of sampling strategy',
         'Not applicable (complete enumeration of available sales)'),
        ('', '',
         '(e) Describe any sensitivity analyses',
         'Welch\u2019s t-test as sensitivity analysis; quarterly aggregation for '
         'trend robustness'),
        ('Results', '', '', ''),
        ('Participants', '13',
        ...
        ('', '',
         ...
         'Materials and Methods, \u201cEligibility criteria\u201d: exclusion criteria listed'),
        ('', '',
        ...
        ('', '',
         ...
         'Materials and Methods, \u201cVariables\u201d: regulatory period cutpoints defined'),
        ('', '',
        ...
        ('Limitations', '19',
         ...
         'Discussion, \u201cLimitations\u201d paragraph: observational design, single '
         'marketplace, no condition data, small post-ban n, global marketplace, '
         'no pre-proposal baseline, no causal inference'),
        ('Interpretation', '20',
    ...
    path = os.path.join(out_dir, 'jatm_strobe_checklist.docx')
    doc.save(path)
    print(f"JATM STROBE checklist saved: {path}")
    return path
