...
def main():
    ...
    add_bullet(doc, '4. Multiple testing across trend tests.',
        ...
        f'(\u03c1={fmt_float(iso_tr.get("spearman_rho"), 2)}, '
        f'P={fmt_p(iso_tr.get("spearman_p"))}) and Kendall \u03c4 '
        f'(\u03c4={fmt_float(iso_tr.get("kendall_tau"), 2)}, '
        f'P={fmt_p(iso_tr.get("kendall_p"))}) tests reached nominal significance at '
